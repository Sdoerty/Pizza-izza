...
import 'package:pizza_izza/profile/toast.dart';
...
class _SignInState extends State<SignIn> {
    ...
    if(_formKey.currentState!.validate())
    {
      ...
      PhoneVerificationCompleted verificationCompleted = (PhoneAuthCredential phoneAuthCredential) async {
        ...
        if(!error&&user!=null){
          ...
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>HomeScreen(phone: userPhone)));
        }
      };
      ...
      PhoneCodeSent codeSent = (String? verificationId, [int? forceResendingToken]) async {
        showToast('Ожидайте СМС с кодом.');
      ...
      try {
        ...
        showToast("Ошибка верификации номера: $e");
        showOtpScreen=false;
      }
      setState(() {
        loading=false;
  ...
  void signInWithPhoneNumber() async {
    ...
    try {
      ...
      showToast("Ошибка входа: " + e.toString());
      error=true;
    }
